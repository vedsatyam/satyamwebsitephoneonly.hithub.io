...
function getdata(){
    firebase.database().ref('blogs/').once('value').then(function(snapshot){
      ...
      for(let[key,value] of Object.entries(data)){
        ...
        "<div class='card-body'><p class='card-text' href="+value.refrence+">"+value.text_title+"</p> <p class='card-text' href="+value.refrence+"> "+value.text+" </p>"+
        "<button class='btn btn-outline-danger' id='"+key+"' onclick='delete_post(this.id)'>Delete</button>"+
